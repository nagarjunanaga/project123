CREATE USER user12 password '34klq*';
...
GRANT SELECT, INSERT, UPDATE, DELETE on authors to user12;
GRANT SELECT, INSERT, UPDATE, DELETE on books to user12;
GRANT SELECT, INSERT, UPDATE, DELETE on testing to user12;
GRANT SELECT, INSERT, UPDATE, DELETE on images to user12;
